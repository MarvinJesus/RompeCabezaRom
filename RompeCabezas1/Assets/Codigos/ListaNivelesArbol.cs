...
{
    public class ListaNivelesArbol
    {
        private Node head = null;
        private int log;
        private static ListaNivelesArbol instance;
        private ListaNivelesArbol() {
            this.log = 0;
        }
        public static ListaNivelesArbol getInstan() {
            if (instance != null)
            {
                return instance;
            }
            else {
                instance = new ListaNivelesArbol();
                return instance;
            } 
        }
        private ListaNivelesArbol(Node pNext)
        {
            this.head = pNext;
            this.log = 0;
        }
