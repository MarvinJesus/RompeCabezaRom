...
{
    class ListaScorePlayerOne
    {
        private Node head = null;
        private int log;
        private static ListaScorePlayerOne instance;
        private ListaScorePlayerOne()
        {
            this.log = 0;
        }
        public static ListaScorePlayerOne getInstan()
        {
            if (instance != null)
            {
                return instance;
            ...
            {
                instance = new ListaScorePlayerOne();
                return instance;
            }
        }
        private ListaScorePlayerOne(Node pNext)
        {
            this.log = 0;
        }
        public Node getHead()
